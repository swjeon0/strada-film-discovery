...
CREATE TRIGGER IF NOT EXISTS academic_full_text_admission
BEFORE INSERT ON document_versions
WHEN NEW.source_type = 'academic' AND NEW.access != 'full_page' BEGIN
  SELECT RAISE(ABORT,'academic admission requires accessed full text');
END;
