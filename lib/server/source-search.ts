...
export function responseUsage(data:any,model:string):ResearchUsage{
 ...
 const [inputRate,cachedRate,outputRate]=actual.includes('5.4-mini')?[.75,.075,4.5]:actual.includes('4.1-mini')?[.4,.1,1.6]:[.15,.075,.6];
